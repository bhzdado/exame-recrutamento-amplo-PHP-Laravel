...
<body
    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none" style="background-color:white;">
                <img src="{{ asset('images/logo_prodemge.png') }}" alt="Logo">
                <h4 class="mb-1 font-medium" style="font-size:20px; margin-top:20px; color: #4C4C4C;">Exame Recrutamento Amplo [PHP - Laravel]</h4>
            </div>
        </main>
    </div>
